...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Products_designer_Top": {
      "callbacks": {}
    },
    "Produc_Designer_Title": {
      "callbacks": {}
    },
    "Product_Designer_Bottom": {
      "callbacks": {}
    },
    "Flex39": {
      "callbacks": {}
    },
    "Eduction_&_WE_&Wrapper": {
      "callbacks": {}
    },
    "Eduction_&_WE": {
      "callbacks": {}
    ...
    "Image59": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/arrow_forward_FILL0_wght400_GRAD0_opsz48.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "title2": {
      "custom": {
        "text": "that delight and inspie people."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image60": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-right-arrow-30.png"
      },
      "callbacks": {
        "onClick": [
          {
